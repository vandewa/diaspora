            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    return
                        ...
                        <a href="' . route('berita.edit', $data->id) . '" class="btn btn-outline-primary rounded-round"><i class="icon-key mr-2"></i>Edit</a>
                        <a href="' . route('berita.destroy', $data->id) . '" class="btn btn-outline-danger rounded-round delete-data-table"><i class="icon-trash mr-2"></i>Hapus</a>
                    </div>';
                })
                ->addColumn(
                    'tombol',
